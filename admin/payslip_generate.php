...
if ($_POST['id']) {
	$user_id = $_POST['id'];
	$mysql = "SELECT amount FROM deductions WHERE $user_id = id";
	$myquery = $conn->query($mysql);
	if ($srow = $myquery->fetch_assoc()) {
		$contents .= '
			...
			<table cellspacing="0" cellpadding="3">  
				 <tr> 
    	    		...
    	    		<td></td>
				 	...
				 	<td width="25%" align="right">' . number_format($srow['user_id'], 2) . '</td> 
    	    	</tr> 
				 <tr> 
    	    		<td></td> 
    	    		<td></td>
...
while ($row = $query->fetch_assoc()) {
	...
	$contents .= '
			<h2 align="center">CAFE CERVEZA EMPLOYEE PAYSLIP</h2>
			...
			<table cellspacing="0" cellpadding="3">  
    	    	...
    	    	<tr> 
				 ...
				 <tr> 
    	    		...
    	    		<td></td>
				 	<td width="25%" align="right">Pag ibig:</td>
				 	<td width="25%" align="right">' . number_format($row['amount'], 2) . '</td> 
    	    	</tr> 
				 <tr> 
    	    		<td></td> 
    	    		<td></td>
