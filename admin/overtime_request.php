...
<body class="hold-transition skin-black sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>Employees</li>
                    <li class="active">Overtime request</li>
                </ol>
            </section>
            <!-- Main content -->
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <table id="shifting_request_table" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT overtime.*, employees.firstname, employees.lastname 
        FROM overtime 
        LEFT JOIN employees ON overtime.employee_id = employees.employee_id 
        ORDER BY overtime.date_overtime DESC";
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<tr>";
                                                echo "<td>" . date('M d, Y', strtotime($row['date_overtime'])) . "</td>";
                                                ...
                                                if ($row["status"] === 'Pending') {
                                                    ...
                                                    echo "<form action='update_overtime_status.php' method='post'>";
    ...
    <script>
        /*  function approveRequest(id) {
            ...
            $.ajax({
                type: 'POST',
                url: 'update_overtime_status.php',
                data: {
                    id: id,
                    status: 'Approved'
                },
